...
export function NewFormActionWrapper({
  ...
  return (
    <div className="flex flex-col gap-2 lg:gap-3 pt-3 bg-slate-100  dark:bg-slate-800 sticky mt-auto shadow border-t-slate-200 dark:border-t-slate-700 bottom-0">
      {children}
    </div>
  )
}
