  ...
  return (
    <LandingSectionWrapper id="about" className="bg-slate-50">
      <LandingContentWrapper>
        ...
        <div className="bg-white shadow w-full max-w-4xl rounded-lg p-8 md:p-10 my-3 md:my-4 flex flex-col items-center gap-3 md:gap-4">
