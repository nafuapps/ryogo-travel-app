          ...
          >
            ...
            {recentSearches?.map((s) => {
              return (
                <div
                  key={s}
                  className="flex items-center justify-center rounded-lg px-2 py-1 lg:px-3 lg:py-1.5 hover:underline bg-slate-100 dark:bg-slate-700 hover:bg-slate-300 dark:hover:bg-slate-700"
                  onClick={() => {
