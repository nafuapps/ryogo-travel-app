...
export default function VehiclesScheduleChartComponent({
  ...
  return (
      ...
      >
        ...
        >
          <div className="flex flex-row justify-end sm:justify-center items-center ">
            <CaptionGrey>{t("Vehicle")}</CaptionGrey>
          </div>
          <div
    ...
    sm:grid-rows-[repeat(var(--items),1fr)]"
        ...
        <div
          id="VehiclesScheduleChartContent"
          className="flex flex-row sm:flex-col gap-1 lg:gap-1.5 w-full"
        >
          <div
            id="VehiclesScheduleChartDayAxis"
          ...
          <div
            id="VehiclesScheduleChartContainer"
...
function RepairPopoverCard(props: {
  id: string
  startDate: Date
  endDate: Date
  vehicleId: string
