...
export default async function TrySubscriptionComponent({
  ...
  return (
    <div className="w-full flex flex-col shrink-0 lg:flex-row lg:justify-between lg:items-center gap-3 md:gap-4 lg:gap-5 rounded-lg px-6 md:px-8 py-12 md:py-16 bg-linear-to-b from-sky-900 to-sky-700">
      <div className="flex flex-col gap-4 md:gap-5 lg:gap-6 w-full">
        <div className="bg-linear-to-r from-sky-700/30 to-sky-600/30 border border-sky-700 flex items-center gap-1.5 md:gap-2 rounded-full px-2 py-1 md:px-3 md:py-1.5 lg:px-4 lg:py-2 self-start">
