...
export default async function TryPremiumComponent({
  ...
  return (
    <div
      id="getPremium"
      className="w-full flex flex-col shrink-0 lg:flex-row lg:justify-between lg:items-center gap-3 md:gap-4 lg:gap-5 rounded-lg px-6 md:px-8 py-12 md:py-16 bg-linear-to-b from-sky-900 dark:from-sky-50 to-sky-700 dark:to-sky-200"
    >
